...
function exec_test()
{
	...
	wait $!
	ES_1=$?
	TEST1=$(grep -v 'Minishell>' msh_log | grep -v 'exit')
	# TEST1=$(cat msh_log)
...
exec_test "echo "coucou'$HOME'/Document""
exec_test "echo "coucou'$HO'ME/Document""
exec_test "echo "coucou$'HO'ME/Document""
exec_test "echo "coucou$HOME/Document""
...
exec_test "export SALUT=\"ls -la\" ; export YO=\$SALUT, echo \$YO"
exec_test "export SALUT=\"cat -e\" ; wc -l \$SALUT ; echo \$YO"
exec_test "unset SALUT ; unset YO"
